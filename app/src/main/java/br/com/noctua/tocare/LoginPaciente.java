...
public class LoginPaciente extends AppCompatActivity {
    ...
    String url_acesso = "https://tocaredev.azurewebsites.net/api/pessoa/login";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //internet
        rq = Volley.newRequestQueue(LoginPaciente.this);
    ...
    public void login() {
        ...
        progressDialog = new ProgressDialog(LoginPaciente.this,
